...
export default function FollowingScreen() {
  ...
  const fetchFollowing = async () => {
    try {
      const { data } = await profileApi.following(username!);
      setFollowing(data.data || data.following || data);
    } catch (error) {
  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      <FlatList
        ...
        ListEmptyComponent={<View style={styles.empty}><Text style={styles.emptyText}>Não segue ninguém ainda</Text></View>}
      />
    </SafeAreaView>
  );
}
